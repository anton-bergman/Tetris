...
public class DiagramViewer
{
	...
	for (int i = 0; i < 10; i++) {
		...
		case 0:
		    comp.addShape(DiagramViewer.getRandomCircle());
		    break;
		case 1:
		    comp.addShape(DiagramViewer.getRandomRectangle());
		    break;
		case 2:
		    comp.addShape(DiagramViewer.getRandomText());
		    break;
	    }
	}
